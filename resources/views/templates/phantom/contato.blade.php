		...
		<!-- Wrapper -->
			...
			<x-base.header :configs="$configs" />
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1 class="header-txt">Encaminhe aqui sua Duvida</h1>
							<div class="inner">
                                <div class="duvida">
        <section>
            <h2>Nos encaminhe sua duvida que assim que possivel iremos auxiliar</h2>
            <form method="post" action="#">
                <div class="fields">
                    ...
                    <div class="field">
                        <textarea name="message" id="message" placeholder="insira aqui sua Duvida"></textarea>
                    </div>
                </div>
                <ul class="actions">
