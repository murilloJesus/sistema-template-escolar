			...
			<div id="wrapper">
				...
				<!-- Main -->
					<section id="main" class="wrapper">
                        <h1 class="major">Acompanhe alguns de nossos Projetos</h1>
                            <div class="projetos">
							<span class="image fit"><img src="/public/assets/hype/images/pic04.jpg" alt="" /></span>
							<p class="txt"> <b>NOME DO PROJETO:</b> Descrição Sobre ele   </p>
                        </div>
                        <div class="projetos">
							<span class="image fit"><img src="/public/assets/hype/images/pic04.jpg" alt="" /></span>
							<p class="txt"> <b>NOME DO PROJETO:</b> Descrição Sobre ele   </p>
