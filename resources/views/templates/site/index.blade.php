			...
			<!-- Two -->
				<section id="two" class="spotlight style2 right">
					...
					<div class="content">
						...
						<ul class="actions">
							<li><a href="/public/assts-site/views/metodologia/metodologia.html" class="button">Veja mais</a></li>
						</ul>
					</div>
			...
			<!-- Three -->
				<section id="three" class="spotlight style3 left">
					...
					<div class="content">
						...
						<ul class="actions">
							<li><a href="/public/assts-site/views/atividades-extras/atividades-extras.html" class="button">Veja Mais</a></li>
						</ul>
					</div>
